...
namespace WebApi2.RedisOutputCache.Tests
{
    ...
    public class InlineInvalidateTests
    {
        ...
        public void inline_call_to_invalidate_is_correct()
        {
            ...
            _cache.Verify(s => s.RemoveStartsWith(It.Is<string>(x => x == "webapi2.redisoutputcache.tests.testcontrollers.inlineinvalidatecontroller-get_c100_s100")), Times.Exactly(1));
        }
        ...
        public void inline_call_to_invalidate_using_expression_tree_with_param_is_correct()
        {
            ...
            _cache.Verify(s => s.RemoveStartsWith(It.Is<string>(x => x == "webapi2.redisoutputcache.tests.testcontrollers.inlineinvalidatecontroller-get_c100_s100_with_param")), Times.Exactly(1));
        }
        ...
        public void inline_call_to_invalidate_using_expression_tree_with_custom_action_name_is_correct()
        {
            ...
            _cache.Verify(s => s.RemoveStartsWith(It.Is<string>(x => x == "webapi2.redisoutputcache.tests.testcontrollers.inlineinvalidatecontroller-getbyid")), Times.Exactly(1));
        }
