...
namespace WebApi2.RedisOutputCache.Tests
{
    ...
    public class ConfigurationTests
    {
        ...
        public void cache_singleton_in_pipeline()
        {
            ...
            _cache.Verify(s => s.Contains(It.Is<string>(x => x == "webapi2.redisoutputcache.tests.testcontrollers.samplecontroller-get_c100_s100:application/json; charset=utf-8")), Times.Exactly(4));
